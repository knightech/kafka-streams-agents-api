...
public class Agent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9067695783471249347L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Agent\",\"namespace\":\"net.knightech.agent\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Agent(java.lang.String id, java.lang.String firstName, java.lang.String lastName, java.lang.String email) {
    this.id = id;
   ...
   */
  public static net.knightech.agent.Agent.Builder newBuilder() {
    return new net.knightech.agent.Agent.Builder();
  }
   ...
   * @return A new Agent RecordBuilder
   */
  public static net.knightech.agent.Agent.Builder newBuilder(net.knightech.agent.Agent.Builder other) {
    if (other == null) {
      return new net.knightech.agent.Agent.Builder();
    } else {
      return new net.knightech.agent.Agent.Builder(other);
    }
  }
   ...
   * @return A new Agent RecordBuilder
   */
  public static net.knightech.agent.Agent.Builder newBuilder(net.knightech.agent.Agent other) {
    if (other == null) {
      return new net.knightech.agent.Agent.Builder();
    } else {
      return new net.knightech.agent.Agent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Agent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.knightech.agent.Agent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.knightech.agent.Agent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.knightech.agent.Agent.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.knightech.agent.Agent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.knightech.agent.Agent.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.knightech.agent.Agent.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.knightech.agent.Agent.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.knightech.agent.Agent.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.knightech.agent.Agent.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.knightech.agent.Agent.Builder clearEmail() {
      email = null;
